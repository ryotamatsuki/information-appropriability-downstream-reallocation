...
\]
because $p-c_S-m>0$ and $p-c_R>0$. For the second inequality, note that the social marginal value of product improvement includes consumer surplus in addition to the coordinated operating margins. Direct substitution of \eqref{eq:ec} and \eqref{eq:ew}, together with $a>p$, $c_S>c_R$, and $k>\beta^2$, yields $\Esocial-\Ecoordinated>0$.
\end{proof}
